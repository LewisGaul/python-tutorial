...
i = 0
text_list = list(range(len(shuffle_order)))
for j in shuffle_order:
    text_list[j] = shuffled_instructions[i]
    i += 1

instructions = ''.join(text_list) #Try help(str) or help(str.join) in shell
...
for i in range(800, 1001):
    if i % 6 == 0 and i % 14 == 0:
        multiples.append(i)
print("Multiples of 6 or 14 from 800 to 1000:", multiples, sep='\n')
...
print("Powers less than 1000 of the odd numbers from 3 to 10:")
i = 3
